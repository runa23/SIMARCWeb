<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SC_SaveLayout.ascx.vb" Inherits="Control_SC_SaveLayout" %>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <dx:GridViewCommandColumn ShowInCustomizationForm="True" 
                ShowSelectCheckbox="True" VisibleIndex="0" ShowEditButton="True" 
